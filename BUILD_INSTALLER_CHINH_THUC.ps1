...
if ([string]$Package.version -ne "1.3.2") {
  throw ("Official installer requires package version 1.3.2, found " + [string]$Package.version)
}

Write-Host "============================================================" -ForegroundColor Red
Write-Host "  DOWNLOAD VIDEO TUBMEDIA 1.3.2 - OFFICIAL BUILD" -ForegroundColor Red
Write-Host "============================================================" -ForegroundColor Red
...
Run-Step "Verify stable 1.3.2 identity" {
...
$Installer = Join-Path $ProjectRoot "release\Download video Tubmedia-Setup-1.3.2-x64.exe"
...
$HashFile = Join-Path $ProjectRoot "release\Download-video-Tubmedia-1.3.2-SHA256.txt"
$HashContent = @(
  "TUBMEDIA 1.3.2",
